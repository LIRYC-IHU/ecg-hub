...
func (r *RoleRepo) Update(ctx context.Context, id uint, description string, permissions []string) error {
...
func (r *RoleRepo) AnyOtherRoleHasPermission(ctx context.Context, permission string, excludeRoleID uint) (bool, error) {
	var count int64
...
func (r *RoleRepo) setPermissions(ctx context.Context, roleID uint, permissions []string) error {
...
func (r *RoleRepo) loadPermissions(ctx context.Context, roleID uint) ([]string, error) {
