...
const PERMISSION_GROUPS = [
  ...
  { key: 'ecg',         labelKey: 'admin.roles.group.ecg',         permissions: ['ecg.read', 'ecg.write', 'ecg.download', 'ecg.delete', 'ecg.upload'] },
  { key: 'hl7',         labelKey: 'admin.roles.group.hl7',         permissions: ['ecg.force_hl7', 'ecg.send_result', 'hl7.config', 'hl7.bulk_retry'] },
  ...
  { key: 'swagger',     labelKey: 'admin.roles.group.swagger',     permissions: ['swagger.read', 'apikey.manage'] },
